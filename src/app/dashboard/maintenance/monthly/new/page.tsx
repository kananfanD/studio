...
export default function NewMonthlyTaskPage() {
  ...
  function onSubmit(data: TaskFormValues) {
    ...
    const taskUniqueId = (isEditMode && taskIdToEdit) ? taskIdToEdit : `mt${Date.now()}`;
    ...
    window.dispatchEvent(new StorageEvent('storage', { key: 'monthlyTasks', newValue: JSON.stringify(tasks), storageArea: localStorage }));
    ...
    const taskForLog: CombinedTask = {
        ...
        status: data.status || "Pending",
        type: "Monthly" as MaintenanceTaskType,
