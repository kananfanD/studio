...
const initialMonthlyTasks: MonthlyTask[] = [
  { id: "mt001", taskName: "Full System Diagnostics - Unit A", machineId: "CNC-001", dueDate: "End of Month", status: "Pending", priority: "High", description: "Run full system diagnostics.", imageUrl: "https://placehold.co/600x400.png?text=Diagnostics"},
  { id: "mt002", taskName: "Replace Wear Parts - Press 002", machineId: "PRESS-002", dueDate: "Mid Month", status: "Completed", assignedTo: "Maintenance Dept.", priority: "Medium", description: "Replace designated wear parts.", imageUrl: "https://placehold.co/600x400.png?text=Wear+Parts" },
  { id: "mt003", taskName: "Calibration Check - All Robots", machineId: "ROBOT-CELL", dueDate: "This Month", status: "Pending", priority: "Medium", description: "Perform calibration checks.", imageUrl: "https://placehold.co/600x400.png?text=Calibration" },
];
...
export default function MonthlyMaintenancePage() {
  ...
  useEffect(() => {
    if(monthlyTasks.length > 0 || localStorage.getItem("monthlyTasks")){
