...
export default function NewWeeklyTaskPage() {
  ...
  return (
    <>
      <PageHeader
        title={isEditMode ? "Edit Weekly Task" : "Add New Weekly Task"}
        description={isEditMode ? "Update the details of the weekly maintenance task." : "Fill in the details for the new weekly maintenance task."}
      >
        <Button variant="outline" asChild>
          <Link href="/dashboard/maintenance/weekly">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., Lubrication - Main Gearbox" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., This Week, End of Week, YYYY-MM-DD" {...field} />
                    </FormControl>
                    <FormDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., Team A" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                <div className="mt-4">
                  ...
                  <div className="relative mt-2 h-48 w-full max-w-xs rounded-md border bg-muted/30 flex items-center justify-center">
                    <Image
                      ...
                      data-ai-hint="task image weekly"
                    />
                  </div>
                </div>
              )}
              <div className="flex justify-end space-x-2 pt-4">
                <Button type="button" variant="outline" onClick={() => router.push('/dashboard/maintenance/weekly')}>
                  Cancel
                </Button>
                <Button type="submit">
