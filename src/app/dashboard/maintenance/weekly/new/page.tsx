...
export default function NewWeeklyTaskPage() {
  ...
  const form = useForm<TaskFormValues>({
    ...
    defaultValues: {
      taskName: "",
      machineId: "",
      dueDate: "This Week", // Default for weekly
      assignedTo: "",
      priority: "Medium",
      description: "",
    },
  ...
  function onSubmit(data: TaskFormValues) {
    console.log("New weekly task data:", data);
    toast({
  ...
  return (
    <>
      <PageHeader
        title="Add New Weekly Task"
        description="Fill in the details for the new weekly maintenance task."
      >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., This Week, End of Week" {...field} />
                    </FormControl>
                    <FormDescription>
